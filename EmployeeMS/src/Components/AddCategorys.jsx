...
const AddCategorys = () => {
    ...
    const handleSubmit = (e) =>{
        e.preventDefault()
       axios.post('http://localhost:3000/auth/add_categorys', {category})
        .then(result => {
...
<div className='p-2 d-flex justify-content-center align-items-center h-100 '>
      ...
      <div className='p-4 rounded w-90 border ' id="catgo">
      <Link to="/sidebar/category" className='btn btn-primary mt-1 ml-1 w-20'>Back</Link>
